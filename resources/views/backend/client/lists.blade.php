                    ...
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                            <button type="button" class="btn btn-info"
                                onclick="location.href = '/backend/dealer/client/lists/add';">新增</button>
                        </div>
                        @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn green btn-xs" href="/backend/dealer/client/lists/upd/{{ $rs->id }}">編輯</a>
                                        @endif
...
<div class="modal fade draggable-modal" id="draggable" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/backend/dealer/client/lists/delData" method="post" id="DeleteActions">
                @csrf
