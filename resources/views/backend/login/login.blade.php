    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" method="post">
                ...
                @php ($isError = true)
                @if($errors->has('email'))
                    @php ($errorMsg = $errors->first('email'))
                @elseif($errors->has('password'))
                    @php ($errorMsg = $errors->first('password'))
                @elseif($errors->has('captcha'))
                    @php ($errorMsg = $errors->first('captcha'))
                @elseif ($errors->has('fail'))
                    @php ($errorMsg = $errors->first('fail'))
                @else
                    @php ($isError = false)
                @endif

                <div class="alert alert-danger @if(!$isError) display-hide @endif">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="請輸入帳號" name="email" /> </div>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">密碼</label>
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="請輸入密碼" name="password" /> </div>
                </div>
